...
write.xlsx(accuracy, file = "Gene_C5.0_accuracy.xlsx")
write.xlsx(comparison, file = "Gene_C5.0_comparison.xlsx")
write.xlsx(confusionMatrix, file = "Gene_C5.0_confusionMatrix.xlsx")
