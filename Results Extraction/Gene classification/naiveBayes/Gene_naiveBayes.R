...
write.xlsx(accuracy, file = "Gene_naiveBayes_accuracy.xlsx")
write.xlsx(comparison, file = "Gene_naiveBayes_comparison.xlsx")
write.xlsx(confusionMatrix, file = "Gene_naiveBayes_confusionMatrix.xlsx")
