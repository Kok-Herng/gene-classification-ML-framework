...
write.xlsx(accuracy, file = "Trait_C5.0_accuracy.xlsx")
write.xlsx(comparison, file = "Trait_C5.0_comparison.xlsx")
write.xlsx(confusionMatrix, file = "Trait_C5.0_confusionMatrix.xlsx")
