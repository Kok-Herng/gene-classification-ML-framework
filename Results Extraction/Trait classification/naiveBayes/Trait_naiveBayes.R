...
write.xlsx(accuracy, file = "Trait_naiveBayes_accuracy.xlsx")
write.xlsx(comparison, file = "Trait_naiveBayes_comparison.xlsx")
write.xlsx(confusionMatrix, file = "Trait_naiveBayes_confusionMatrix.xlsx")
